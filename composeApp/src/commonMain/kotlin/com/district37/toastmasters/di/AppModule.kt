...
import com.district37.toastmasters.ActiveConferenceResolver
...
import com.district37.toastmasters.devsettings.devSettingsModule
...
fun appModule(appContext: Any? = null) = module {
    ...
    singleOf(::ActiveConferenceResolver)
    ...
    singleOf(::DevSettingsRepository)
