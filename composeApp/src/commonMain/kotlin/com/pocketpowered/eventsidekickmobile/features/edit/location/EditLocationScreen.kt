...
fun EditLocationScreen(
    ...
    val floorLevel by viewModel.floorLevel.collectAsState()
    ...
    if (formResult is FormResult.Error) {
        AlertDialog(
            ...
            title = { Text("Error") },
            text = { Text((formResult as FormResult.Error).message ?: "Failed to update location") },
            confirmButton = {
    ...
    if (loadError != null) {
        Box(
            ...
            Column(
                ...
                Text(
                    text = loadError ?: "Failed to load location",
    ...
    EntityFormScaffold(
        ...
        FormTextField(
            ...
            label = "Location Type",
            placeholder = "e.g., Stage, Room, Hall, etc.",
            enabled = !isSubmitting,
            modifier = Modifier.fillMaxWidth()
        )
